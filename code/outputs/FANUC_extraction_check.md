...
The following four kinds of manuals are available for the FANUC SERVO MOTOR αi-D series.
...
"SERVO MOTOR αi-D series DESCRIPTIONS" 
(B-65542EN)
...
○ 
"SERVO AMPLIFIER αi-D series DESCRIPTIONS" 
(B-65552EN)
...
With 70Nm brake and cooling fan 
Symbol in 
specification No. 
Servo motor name 
□□□□ 
...
```text
204 
γb : Mass of the object per unit volume [kg/cm3] 
Db : Diameter of the object [cm] 
Lb : Length of the object [cm]

[Example of calculation for condition 3-1] Load moment of inertia 
When the shaft of a ball screw is made of steel (γb = 7.8 × 103 [kg/m3]), moment of inertia Jb of the shaft is calculated 
as follows: When Db = 0.040 [m], Lb = 1 [m], 
Jb = 7.8 × 103 × π ÷ 32 × 0.0404 × 1 = 0.00196 [kg⋅m2] = 0.0200 [kgf⋅cm⋅s2]

Moment of inertia of a heavy object moving along a straight line (table, workpiece, etc.) 
-SI unit--------------------------- 
  [kg⋅m2] 
w : Mass of the object moving along a straight line [kg] 
l : Traveling distance along a straight line per revolution of the motor [m]
...
*2 The steady-state load torque indicates the steady-state component (gravity axis includes brake torque) per motor rotation. We would like you to provide as much information as possible, but if details are unknown, use a value theoretically calculated based on the 
